...
"""
This launch file has been created to streamline the use of the original `ur_robot_driver/launch/ur_control.launch.py`
for users.
Specifically, it simplifies the process of passing the `controllers_file`, `kinematics_params_file` and `ur_type` arguments to
the official launch file.
"""
...
def launch_setup(context, *args, **kwargs):
    ...
    return [ur_control_launch, force_torque_sensor_broadcaster]
