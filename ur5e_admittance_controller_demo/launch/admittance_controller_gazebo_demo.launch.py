...
DEFAULT_FT_CONTROLLERS_FILE = "ur5e_simulation_admittance_controller_wall.yaml"
DEFAULT_EFFORT_FT_CONTROLLERS_FILE = (
    "ur5e_simulation_admittance_controller_wall_effort.yaml"
)
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="ur5e_admittance_controller_demo",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "ee_config_file",
            default_value="config/ft_sensor_and_long_handle_ee_config.yaml",
