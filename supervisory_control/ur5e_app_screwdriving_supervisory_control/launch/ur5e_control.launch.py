...
def launch_setup(context, *args, **kwargs):
    ...
    ur5e_moveit_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            "description_package": description_package,
            "description_file": description_file,
            "moveit_config_package": "acg_resources_ur5e_moveit_config",
            "moveit_config_file": "ur5e_with_end_effector.srdf.xacro",
            "prefix": tf_prefix,
            "use_sim_time": "false",
            "rviz_config_package": rviz_config_package,
            "rviz_config_file": rviz_config_file,
    ...
    return [ur_control_launch, ur5e_moveit_launch, plotjuggler_starter]
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="ur5e_app_screwdriving_supervisory_control",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="ur5e_ft_controllers.yaml",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "rviz_config_file",
            default_value="config/ur5e_supervisory_control.rviz",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "ee_config_file",
            default_value="config/ft_sensor_and_screwdriver_ee_config.yaml",
